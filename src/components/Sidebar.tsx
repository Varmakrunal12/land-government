...
const navConfig: Record<RoleType, Array<{ name: string; href: string; icon: any }>> = {
  researcher: [
    { name: "Evidence-Backed AI Engine", href: "/research", icon: Sparkles },
    { name: "GIS & Spatial Analytics", href: "/gis", icon: Map },
    { name: "Earth Observation & RS", href: "/remote-sensing", icon: Satellite },
    { name: "Innovation Hub", href: "/innovation", icon: Lightbulb },
    { name: "Climate & Land Resilience", href: "/climate-resilience", icon: ShieldCheck },
    { name: "Land Dispute Intelligence", href: "/land-disputes", icon: Scale },
  ...
  state: [
    ...
    { name: "Policy Tracking", href: "/policy-tracking", icon: Activity },
    { name: "Innovation Hub", href: "/innovation", icon: Lightbulb },
    { name: "Expert Collaboration", href: "/collaboration", icon: MessageSquare },
  ],
  admin: [
    ...
    { name: "Innovation Hub Admin", href: "/innovation", icon: Lightbulb },
    { name: "Land Dispute Analytics", href: "/land-disputes", icon: Scale },
    { name: "Climate & Resilience", href: "/climate-resilience", icon: ShieldCheck },
    { name: "Expert Collaboration", href: "/collaboration", icon: MessageSquare },
  ]
};
...
const roleDetails: Record<RoleType, { label: string; badgeColor: string; description: string }> = {
  researcher: { 
    ...
    description: "Evidence RAG, Earth Observation & Grants" 
  },
  ministry: { 
    label: "🏛️ Ministry / Policymaker", 
    badgeColor: "bg-amber-100 text-amber-800 border-amber-200", 
    description: "National Policies, Climate & Dispute Analytics" 
  },
  state: { 
    label: "🏢 State Revenue Dept", 
    badgeColor: "bg-emerald-100 text-emerald-800 border-emerald-200", 
    description: "State Cadastral Data & Local Dispute SLA" 
  },
  admin: { 
