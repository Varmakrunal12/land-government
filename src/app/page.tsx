        ...
        <div className="z-10 w-full max-w-5xl mx-auto space-y-8 sm:space-y-10">
          ...
          <div className="text-center space-y-3 px-2">
            ...
            <p className="text-slate-400 text-xs sm:text-sm max-w-3xl mx-auto leading-relaxed px-1">
              Empowering evidence-based policymaking through integrated GIS analytics, AI knowledge engines, policy what-if simulations, remote sensing change detection, and multi-tier stakeholder collaboration across 28 States & 8 UTs.
            </p>
          </div>

          {/* 5 Core Feature Modules Quick-Launch Showcase (SIH Key Requirements) */}
          <div className="space-y-3">
            <div className="flex items-center justify-between px-1">
              <span className="text-xs font-bold text-amber-400 uppercase tracking-wider flex items-center gap-1.5">
                <Sparkles className="h-4 w-4" />
                <span>Core Problem Statement Modules (Direct Access)</span>
              </span>
              <span className="text-[10px] text-slate-400">All 5 PS Pillars Implemented</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
              ...
              <Link
                href="/innovation"
                className="bg-slate-900/90 hover:bg-slate-800 border border-slate-800 hover:border-amber-500/60 rounded-xl p-3.5 transition-all shadow-md flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[9px] font-bold text-amber-400 uppercase">Pillar 15</span>
                  </div>
                  <h4 className="text-xs font-bold text-white group-hover:text-amber-300">Innovation Hub</h4>
                  <p className="text-[10px] text-slate-400 mt-1">Grants, Hackathons, Pilots, Challenges & Quizzes.</p>
                </div>
              ...
              <Link
                ...
                className="bg-slate-900/90 hover:bg-slate-800 border border-slate-800 hover:border-emerald-500/60 rounded-xl p-3.5 transition-all shadow-md flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <div className="p-1.5 bg-emerald-500/10 text-emerald-400 rounded-lg group-hover:bg-emerald-500 group-hover:text-slate-950 transition-colors">
                      <ShieldCheck className="h-4 w-4" />
                    </div>
                    <span className="text-[9px] font-bold text-emerald-400 uppercase">Resilience</span>
                  </div>
                  <h4 className="text-xs font-bold text-white group-hover:text-emerald-300">Climate & Land Resilience</h4>
                  <p className="text-[10px] text-slate-400 mt-1">Flood, Drought, Heat, Salinity & Score Simulator.</p>
                </div>
              ...
              <Link
                href="/land-disputes"
                className="bg-slate-900/90 hover:bg-slate-800 border border-slate-800 hover:border-rose-500/60 rounded-xl p-3.5 transition-all shadow-md flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <div className="p-1.5 bg-rose-500/10 text-rose-400 rounded-lg group-hover:bg-rose-500 group-hover:text-white transition-colors">
                      <Scale className="h-4 w-4" />
                    </div>
                    <span className="text-[9px] font-bold text-rose-400 uppercase">Litigation</span>
                  </div>
                  <h4 className="text-xs font-bold text-white group-hover:text-rose-300">Land Dispute Analytics</h4>
                  <p className="text-[10px] text-slate-400 mt-1">District Stats, 5 Types, Resolution SLA & Hotspots.</p>
                </div>
                <div className="mt-3 text-[10px] font-bold text-rose-400 flex items-center gap-1">
                  <span>Track Disputes</span>
                  <ChevronRight className="h-3 w-3 group-hover:translate-x-0.5 transition-transform" />
                </div>
              </Link>
              ...
              <Link
                href="/remote-sensing"
                className="bg-slate-900/90 hover:bg-slate-800 border border-slate-800 hover:border-cyan-500/60 rounded-xl p-3.5 transition-all shadow-md flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <div className="p-1.5 bg-cyan-500/10 text-cyan-400 rounded-lg group-hover:bg-cyan-500 group-hover:text-slate-950 transition-colors">
                      <Satellite className="h-4 w-4" />
                    </div>
                    <span className="text-[9px] font-bold text-cyan-400 uppercase">ISRO SAC</span>
                  </div>
                  <h4 className="text-xs font-bold text-white group-hover:text-cyan-300">Remote Sensing (EO)</h4>
                  <p className="text-[10px] text-slate-400 mt-1">Ahmedabad 2018-26 Sprawl & Agri-Loss Detection.</p>
                </div>
              ...
              <Link
                href="/research"
                className="bg-slate-900/90 hover:bg-slate-800 border border-slate-800 hover:border-blue-500/60 rounded-xl p-3.5 transition-all shadow-md flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <div className="p-1.5 bg-blue-500/10 text-blue-400 rounded-lg group-hover:bg-blue-500 group-hover:text-white transition-colors">
                      <Sparkles className="h-4 w-4" />
                    </div>
                    <span className="text-[9px] font-bold text-blue-400 uppercase">Multi-RAG</span>
                  </div>
                  <h4 className="text-xs font-bold text-white group-hover:text-blue-300">Evidence-Backed AI</h4>
                  <p className="text-[10px] text-slate-400 mt-1">4-Silo RAG, Inline Citations [1-4] & Briefings.</p>
                </div>
                <div className="mt-3 text-[10px] font-bold text-blue-400 flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 pt-2">
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs sm:text-xs mt-1.5 sm:mt-2 leading-relaxed">
                  Access Evidence-Backed AI RAG Assistant, national land datasets, spatial analytics tools, Earth observation satellite layers, and submit innovation grant proposals.
                </p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs sm:text-xs mt-1.5 sm:mt-2 leading-relaxed">
                  Analyze national land dashboards, Climate & Land Resilience scores, Land Dispute Intelligence, Policy What-If simulations, and evidence-based decision reports.
                </p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs sm:text-xs mt-1.5 sm:mt-2 leading-relaxed">
                  Manage state-level land records, ingest cadastral GeoJSON datasets, monitor district dispute resolution turnaround, and track DILRMP policy execution.
                </p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs sm:text-xs mt-1.5 sm:mt-2 leading-relaxed">
                  User role approvals, dataset validation queues, Innovation Hub proposal approvals, API governance, security access control, and live audit logging.
                </p>
              </div>
